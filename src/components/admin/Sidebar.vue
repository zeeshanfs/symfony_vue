    ...
    >
      <div class="flex items-center justify-center mt-8">
        ...
        <div class="flex items-center">
          ...
          <span class="mx-2 text-2xl font-semibold text-white">Prodcuts</span>
        </div>
      </router-link>
      </div>
      ...
      <nav class="mt-10">
        <router-link
          ...
          :class="[$route.name === 'Prodcuts' ? activeClass : inactiveClass]"
          to="/admin/prodcuts"
        >
          <svg
            class="w-5 h-5"
        ...
        >
          ...
          <span class="mx-4">View Prodcuts</span>
        </router-link>
      </nav>
    </div>
  </div>
